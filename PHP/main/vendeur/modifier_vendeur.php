...
<div class='container section'>
    <div class='section-header'>
        <h2 class='titre-section'>Modifier ce vendeur</h2>
    </div>
    <div class='section-body'>
        <!-- appel du formulaire de modif vendeurs -->
        <?php include $racine.'/components/formulaire/formulaire_modification_vendeur.php'; ?>
    </div>

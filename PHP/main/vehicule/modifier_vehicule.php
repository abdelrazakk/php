...
<div class='container section'>
    <div class='section-header'>
        <h2 class='titre-section'>Modifier ce véhicule</h2>
    </div>
    <div class='section-body'>
        <!-- appel du formulaire de modif vehicule -->
        <?php include $racine.'/components/formulaire/formulaire_modification_vehicule.php'; ?>
    </div>
